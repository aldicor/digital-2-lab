...
HD_PWD='C:/Xilinx/projects/project_procesador_general/project_procesador_general.runs/zynq_ejemplo_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_ejemplo_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_ejemplo_blk_mem_gen_0_0.tcl
