...
/* Definitions for peripheral AXI_GPIO_MOTORES */
#define XPAR_AXI_GPIO_MOTORES_BASEADDR 0x41210000
#define XPAR_AXI_GPIO_MOTORES_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_MOTORES_DEVICE_ID 1
#define XPAR_AXI_GPIO_MOTORES_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_MOTORES_IS_DUAL 0
...
/* Canonical definitions for peripheral AXI_GPIO_MOTORES */
#define XPAR_GPIO_1_BASEADDR 0x41210000
#define XPAR_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_MOTORES_DEVICE_ID
