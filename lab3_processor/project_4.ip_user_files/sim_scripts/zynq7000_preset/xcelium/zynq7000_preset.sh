...
#
# Script generated by Vivado on Sat Jul 12 14:47:17 -0500 2025
...
#
# Usage        : zynq7000_preset.sh
#                zynq7000_preset.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                zynq7000_preset.sh [-reset_run]
#                zynq7000_preset.sh [-reset_log]
#                zynq7000_preset.sh [-help]
#
...
#                script (type 'zynq7000_preset.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname processing_system7_vip_v1_0_16 -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_2 -libname interrupt_control_v3_1_4 -libname axi_gpio_v2_0_30 -libname proc_sys_reset_v5_0_13 -libname axi_bram_ctrl_v4_1_8 -libname blk_mem_gen_v8_4_6 -libname microblaze_v11_0_11 -libname lmb_v10_v3_0_12 -libname lmb_bram_if_cntlr_v4_0_22 -libname axi_intc_v4_1_17 -libname xlconcat_v2_1_4 -libname mdm_v3_2_24 -libname lib_pkg_v1_0_2 -libname axi_timer_v2_0_30 -libname generic_baseblocks_v2_1_0 -libname axi_register_slice_v2_1_28 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_crossbar_v2_1_29 -libname axi_protocol_converter_v2_1_28 -libname axi_mmu_v2_1_26 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 processing_system7_vip_v1_0_16 xil_defaultlib axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_4 axi_gpio_v2_0_30 proc_sys_reset_v5_0_13 axi_bram_ctrl_v4_1_8 blk_mem_gen_v8_4_6 microblaze_v11_0_11 lmb_v10_v3_0_12 lmb_bram_if_cntlr_v4_0_22 axi_intc_v4_1_17 xlconcat_v2_1_4 mdm_v3_2_24 lib_pkg_v1_0_2 axi_timer_v2_0_30 generic_baseblocks_v2_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29 axi_protocol_converter_v2_1_28 axi_mmu_v2_1_26)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "zynq7000_preset.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./zynq7000_preset.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../project_4.gen/sources_1/bd/zynq7000_preset/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../project_4.gen/sources_1/bd/zynq7000_preset/ipshared/aed8/hdl" +incdir+"../../../../project_4.gen/sources_1/bd/zynq7000_preset/ipshared/ec67/hdl" +incdir+"../../../../project_4.gen/sources_1/bd/zynq7000_preset/ipshared/aed8/hdl" +incdir+"D:/programas/vivado/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvhdl -work axi_intc_v4_1_17 $xmvhdl_opts \
  ...
  xmvhdl -work axi_timer_v2_0_30 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.zynq7000_preset xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.zynq7000_preset -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log zynq7000_preset_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: zynq7000_preset.sh [-step]\n\
Usage: zynq7000_preset.sh [-lib_map_path]\n\
Usage: zynq7000_preset.sh [-reset_run]\n\
Usage: zynq7000_preset.sh [-reset_log]\n\
Usage: zynq7000_preset.sh [-keep_index]\n\
