...
##Buttons
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports {sensor_entrada}]; IO_L12N_T1_MRCC_35 Sch=sensor_entrada
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports {sensor_salida}]; IO_L24N_T3_34 Sch=sensor_salida
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { reset }]; IO_L10P_T1_AD11P_35 Sch=reset
...
##RGB LED 6
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { puerta_cerrada }]; IO_L18P_T2_34 Sch=puerta_cerrada
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { puerta_abierta }]; IO_L6N_T0_VREF_35 Sch=puerta_abierta
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { puerta_movimiento }]; IO_L8P_T1_AD10P_35 Sch=puerta_movimiento
